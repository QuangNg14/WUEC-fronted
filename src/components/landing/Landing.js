                ...
                <div className="project-box-wrapper">
                  <div className="project-box" style={{ backgroundColor: '#fee4cb' }}>
                    ...
                    <div className="project-box-content-header">
                      ...
                      <p className="box-content-subheader">Finance, Technology</p>
                    </div>
                    <div className="box-progress-wrapper">
                      <p className="box-progress-header">Number of Projects</p>
                      <div className="box-progress-bar">
                        <span className="box-progress" style={{ width: '60%', backgroundColor: '#ff942e' }} />
                      </div>
                ...
                <div className="project-box-wrapper">
                  <div className="project-box" style={{ backgroundColor: '#e9e7fd' }}>
                    ...
                    <div className="project-box-content-header">
                      ...
                      <p className="box-content-subheader">Education, Technology</p>
                    </div>
                    <div className="box-progress-wrapper">
                      <p className="box-progress-header">Number of Projects</p>
                      <div className="box-progress-bar">
                        <span className="box-progress" style={{ width: '50%', backgroundColor: '#4f3ff0' }} />
                      </div>
                ...
                <div className="project-box-wrapper">
                  <div className="project-box">
                    ...
                    <div className="project-box-content-header">
                      ...
                      <p className="box-content-subheader">Healthcare, Technology</p>
                    </div>
                    <div className="box-progress-wrapper">
                      <p className="box-progress-header">Number of Projects</p>
                      <div className="box-progress-bar">
                        <span className="box-progress" style={{ width: '80%', backgroundColor: '#096c86' }} />
                      </div>
                ...
                <div className="project-box-wrapper">
                  <div className="project-box" style={{ backgroundColor: '#ffd3e2' }}>
                    ...
                    <div className="box-progress-wrapper">
                      <p className="box-progress-header">Number of Projects</p>
                      <div className="box-progress-bar">
                        <span className="box-progress" style={{ width: '20%', backgroundColor: '#df3670' }} />
                      </div>
                ...
                <div className="project-box-wrapper">
                  <div className="project-box" style={{ backgroundColor: '#c8f7dc' }}>
                    ...
                    <div className="box-progress-wrapper">
                      <p className="box-progress-header">Number of Projects</p>
                      <div className="box-progress-bar">
                        <span className="box-progress" style={{ width: '60%', backgroundColor: '#34c471' }} />
                      </div>
                ...
                <div className="project-box-wrapper">
                  <div className="project-box" style={{ backgroundColor: '#d5deff' }}>
                    ...
                    <div className="box-progress-wrapper">
                      <p className="box-progress-header">Number of Projects</p>
                      <div className="box-progress-bar">
                        <span className="box-progress" style={{ width: '40%', backgroundColor: '#4067f9' }} />
                      </div>
              ...
              <div className="messages">
                <div className="message-box">
                  ...
                  <div className="message-content">
                    ...
                    <p className="message-line">
                      I found my co-founder through this incubator. 🥳 I appreciate the initiative.
                    </p>
                ...
                <div className="message-box">
                  ...
                  <div className="message-content">
                    ...
                    <p className="message-line">
                      This is a brilliant way to connect Penn students with similar business ideas.
                    </p>
                    <p className="message-line time">
                      Dec, 12
                    </p>
                ...
                <div className="message-box">
                  ...
                  <div className="message-content">
                    ...
                    <p className="message-line">
                      I am really impressed! Can't wait to see what start-ups Penn students come up with.
                    </p>
                    <p className="message-line time">
                      Dec, 11
                    </p>
      ...
      <footer>
        <div className="footer-container">
          <div className="footer-row">
            ...
            <ul>
              <li>Wharton Undergraduate Entrepreneurship Club © 2022. Made with ♥ in Philly.</li>
            </ul>
          </div>
        </div>
